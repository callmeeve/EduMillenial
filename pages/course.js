                    ...
                    <div className="row justify-content-start mb-4">
                        <div className="col-xl-6">
                            <nav className="nav nav-tabs" id="tabs">
                                <Link selected={isTabOne} href={{ pathname: "/course", query: { tab: "All" } }}><a className="nav-item nav-link">All</a></Link>
                                <Link selected={isTabTwo} href={{ pathname: "/course", query: { tab: "Python" } }}><a className="nav-item nav-link">Python</a></Link>
                                <Link selected={isTabThree} href={{ pathname: "/course", query: { tab: "Javascript" } }}><a className="nav-item nav-link">Javascript</a></Link>
                                <Link selected={isTabFour} href={{ pathname: "/course", query: { tab: "Design Web" } }}><a className="nav-item nav-link">Design Web</a></Link>
                            </nav>
                        </div>
                    </div>
                    <div>
