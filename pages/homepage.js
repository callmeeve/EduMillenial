...
const pembukaDesignWeb = [
    { heading: "From Basic to Expert Desgin Web", text: "Design Web understanding basic to expert." }
];
...
const Homepage = ({ router }) => {
    ...
    const isTabFour = tab === "Design Web"
    return (
        <>
            <Layout>
                    ...
                    <div className="container col-xxl-8 px-4 py-5">
                        <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
                            <div className="col-10 col-sm-8 col-lg-5">
                                <Image src="/BG.png" className="d-block mx-lg-auto img-fluid wp-image-1116" alt loading="lazy" width={800} height={905} />
                            </div>
                    ...
                    <div className="row justify-content-start mb-4">
                        <div className="col-md-12">
                            <nav className="nav nav-tabs" id="tabs">
                                <Link selected={isTabOne} href={{ pathname: "/homepage", query: { tab: "All" } }}><a className="nav-item nav-link">All</a></Link>
                                <Link selected={isTabTwo} href={{ pathname: "/homepage", query: { tab: "Python" } }}><a className="nav-item nav-link">Python</a></Link>
                                <Link selected={isTabThree} href={{ pathname: "/homepage", query: { tab: "Javascript" } }}><a className="nav-item nav-link">Javascript</a></Link>
                                <Link selected={isTabFour} href={{ pathname: "/homepage", query: { tab: "Design Web" } }}><a className="nav-item nav-link">Design Web</a></Link>
                            </nav>
                        </div>
                    </div>
                    <div>
                        ...
                        {isTabFour && <React.Fragment>{pembukaDesignWeb.map((agt, indeks) => (
                            <Header heading={agt.heading} text={agt.text} />
                        ))}</React.Fragment>}
                    </div>
                    <div className="row justify-content-start mb-4">
                    ...
                    <div className="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                        {isTabOne && <React.Fragment>
                            ...
                            {daftarDesainWeb.map((agt, indeks) => (
                                <Youtube video={agt.video} judul={agt.judul} nama={agt.nama} deskripsi={agt.deskripsi} />
                            ))}</React.Fragment>}
